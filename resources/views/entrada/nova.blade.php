...
<section id="main" role="main">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                @if(isset($entradas))
                <form class="panel panel-default" method="post" action="{{ route('entrada.update', $entradas->id) }}" data-parsley-validate>
                    {!! method_field('PUT') !!}
                    @else
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-12"><br>
                                    ...
                                    <input name="tamanho" type="number" value="{{$entradas->tamanho or old('tamanho')}}" class="form-control" required>
                                ...
                                <div class="col-sm-12"><br>
                                    ...
                                    <input name="data_expiracao" type="date" value="{{$entradas->data_expiracao or old('data_expiracao')}}" class="form-control" required>
                                ...
                                <div class="col-sm-12"><br>
                                    ...
                                    <input name="data_entrada" type="date" value="{{$entradas->data_entrada or old('medida')}}" class="form-control" required>
                                ...
                                <div class="col-sm-12"><br>
                                    ...
                                    <input name="quant" type="number" value="{{$entradas->quant or old('quant')}}" class="form-control" required>
                                    @if ($errors->has('quant'))
                                    <span class="help-block">
                                ...
                                <div class="col-sm-12"><br>
                                    ...
                                    <input name="preco_compra" type="number" value="{{$entradas->preco_compra or old('preco_compra')}}" class="form-control" required>
                                ...
                                <div class="col-sm-12"><br>
                                    ...
                                    <input name="preco_venda" type="number" value="{{$entradas->preco_venda or old('preco_venda')}}" class="form-control" required>
